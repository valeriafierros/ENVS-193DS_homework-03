...
[link to homework 03 GitHub repository](https://github.com/valeriafierros/ENVS-193DS_homework-03)
...
```{r}
#| label: checking visual assumptions with scatterplot 
...
```{r}
#| label: checking normality assumptions
#| fig-height: 6
#| fig-width: 8
